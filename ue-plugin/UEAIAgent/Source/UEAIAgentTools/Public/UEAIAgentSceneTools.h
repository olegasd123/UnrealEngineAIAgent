...
struct FUEAIAgentLandscapeGenerateParams
{
    ...
    int32 RiverCountMin = 0;
    int32 RiverCountMax = 0;
    float RiverWidthMin = 0.0f;
    float RiverWidthMax = 0.0f;
    int32 LakeCountMin = 0;
    int32 LakeCountMax = 0;
    float LakeWidthMin = 0.0f;
    float LakeWidthMax = 0.0f;
