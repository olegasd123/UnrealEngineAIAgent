...
bool SUEAIAgentPanel::ExecutePlannedAction(const FUEAIAgentPlannedSceneAction& PlannedAction, FString& OutMessage) const
{
    ...
    if (PlannedAction.Type == EUEAIAgentPlannedActionType::LandscapeGenerate)
    {
        ...
        Params.RiverCountMin = PlannedAction.LandscapeRiverCountMin;
        Params.RiverCountMax = PlannedAction.LandscapeRiverCountMax;
        Params.RiverWidthMin = PlannedAction.LandscapeRiverWidthMin;
        Params.RiverWidthMax = PlannedAction.LandscapeRiverWidthMax;
        Params.LakeCountMin = PlannedAction.LandscapeLakeCountMin;
        Params.LakeCountMax = PlannedAction.LandscapeLakeCountMax;
        Params.LakeWidthMin = PlannedAction.LandscapeLakeWidthMin;
        Params.LakeWidthMax = PlannedAction.LandscapeLakeWidthMax;
