...
- chat endpoints (`/v1/chats`, `/v1/chats/:chatId`, `/v1/chats/:chatId/details`)
...
- `LOCAL_CONTEXT_WINDOW_TOKENS` (default `8192`)
...
- Chats and chat details are stored in SQLite.
...
- Manage chats:
  ...
  - details response includes `contextUsage` object (estimated token usage and percent for selected chat/model)
- Details write model:
